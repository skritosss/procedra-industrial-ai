...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    RATE_LIMIT_DATABASE_PATH=/app/generated/rate_limits.sqlite3 \
...
# /health, not /ready: this runs every 30 seconds for the life of the container,
# so it must not depend on work that grows with the database.
